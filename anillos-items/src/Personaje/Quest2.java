...
public class Quest2 {
    ...
    public void CreateNPC(JFrame window){
        ...
        NPCx = boxSize * 2;						// Declaramos variables para las coordenadas de X e Y que se usar� el Pj.
	NPCy = boxSize;
        
	mapClass.insertMap(NPCx/boxSize, NPCy/boxSize, true,5);
